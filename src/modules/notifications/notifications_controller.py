...
async def test_send_mail_handler():
	result = notifications_service.send_email('user@domain.com', 'Test Mail', 'This is a test mail from BiasBoutique_Server')
